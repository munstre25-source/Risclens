...
export const toolComparisons: ToolComparison[] = [
    ...
    {
      slug: 'scrut-automation-vs-vanta',
      title: 'Scrut Automation vs Vanta: The Mid-Market Compliance Battle',
      description: 'Is Scrut Automation a viable alternative to Vanta for mid-market companies?',
      toolA: { name: 'Scrut Automation' },
      toolB: { name: 'Vanta' },
      tableRows: [
        { feature: 'Market Segment', toolAValue: 'Mid-market, Enterprise', toolBValue: 'Startups, Mid-market' },
        { feature: 'Compliance Depth', toolAValue: 'Deep GRC features, internal audit workflows', toolBValue: 'High automation, security first' },
        { feature: 'Price Point', toolAValue: 'Competitive for larger teams', toolBValue: 'Premium market leader' },
      ],
      verdict: 'Scrut is excellent for companies that need GRC features beyond just SOC 2. Vanta remains the better choice for early startups.',
      faqs: [
        { question: 'Is Scrut cheaper?', answer: 'Scrut often provides better value for multi-framework mid-market deals.' },
      ],
      pricing: {
        toolAStarting: '$12,000/year',
        toolBStarting: '$10,000/year',
        toolACostDrivers: 'Frameworks, users',
        toolBCostDrivers: 'Employees, frameworks',
        toolAHiddenCosts: 'Auditor fees',
        toolBHiddenCosts: 'Auditor fees',
        toolAAuditorIncluded: false,
        toolBAuditorIncluded: false,
        summary: 'Scrut wins on GRC depth; Vanta wins on integration breadth.',
      },
    },
    {
      slug: 'tugboat-logic-vs-vanta',
      title: 'Tugboat Logic (OneTrust) vs Vanta: Guided vs Automated',
      description: 'Comparing the guided approach of Tugboat Logic with the automated approach of Vanta.',
      toolA: { name: 'Tugboat Logic' },
      toolB: { name: 'Vanta' },
      tableRows: [
        { feature: 'Philosophy', toolAValue: 'Guided compliance management', toolBValue: 'Automated evidence collection' },
        { feature: 'Ease of Use', toolAValue: 'High learning curve, very detailed', toolBValue: 'Intuitive, fast setup' },
      ],
      verdict: 'Tugboat Logic is great for teams that want a very structured, old-school compliance approach. Vanta is for modern tech teams.',
      faqs: [],
      pricing: {
        toolAStarting: '$15,000/year',
        toolBStarting: '$10,000/year',
        toolACostDrivers: 'Modules, frameworks',
        toolBCostDrivers: 'Employees',
        toolAHiddenCosts: 'Auditor fees',
        toolBHiddenCosts: 'Auditor fees',
        toolAAuditorIncluded: false,
        toolBAuditorIncluded: false,
        summary: 'Vanta is generally more modern and faster to implement.',
      },
    },
  {
