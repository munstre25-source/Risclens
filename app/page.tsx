    ...
    <>
      <main className="min-h-screen flex flex-col bg-slate-50">
        ...
        <section className="bg-white border-b border-slate-200 overflow-hidden relative">
          ...
          <div className="max-w-6xl mx-auto px-4 pt-24 pb-32 relative text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 border border-brand-100 mb-8">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 leading-[1.1] tracking-tight mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                className="w-full sm:w-auto bg-slate-900 text-white text-lg font-bold px-10 py-5 rounded-xl shadow-xl hover:bg-slate-800 transition-all flex flex-col items-center group"
              >
              ...
              <Link
                ...
                className="w-full sm:w-auto bg-brand-600 text-white text-lg font-bold px-10 py-5 rounded-xl shadow-xl hover:bg-brand-700 transition-all flex flex-col items-center group"
              >
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-x-12 gap-y-6 opacity-40 grayscale pointer-events-none">
