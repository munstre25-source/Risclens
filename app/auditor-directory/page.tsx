      ...
      <div className="flex-grow">
          ...
          <section className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="lg:col-span-3">
                  <div className="grid gap-6">
                    {auditors.map((auditor) => (
                      <div key={auditor.slug} className="group bg-white p-8 rounded-xl border border-slate-200 shadow-sm hover:border-slate-300 transition-all">
                        <div className="flex flex-col md:flex-row gap-8">
                          ...
                          <div className="flex flex-col gap-3 min-w-[200px]">
                            <Link 
                              ...
                              className="flex items-center justify-center py-3 rounded-lg bg-slate-900 text-white font-medium hover:bg-slate-800 transition-all shadow-sm"
                            >
                              View Profile
                            </Link>
                            <Link 
              ...
              <div className="mt-24 p-12 bg-slate-900 rounded-xl text-white overflow-hidden relative">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                    <Link 
                      ...
                      className="bg-white text-slate-900 px-10 py-4 rounded-lg font-medium hover:bg-slate-100 transition-all text-center"
                    >
                      Apply for Partnership
                    </Link>
                    <Link 
                      href="/methodology"
                      className="bg-slate-800 text-white px-10 py-4 rounded-lg font-medium hover:bg-slate-700 transition-all text-center border border-slate-700"
                    >
                      Learn Methodology
                    </Link>
                  </div>
