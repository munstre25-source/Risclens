...
function CalculatorSkeleton() {
  return (
    <div className="max-w-2xl mx-auto h-[400px] bg-white rounded-2xl border border-gray-100 animate-pulse flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow py-20 px-4">
        ...
        <article className="max-w-3xl mx-auto px-4 py-16 bg-white border-t border-slate-200 mt-20 rounded-2xl shadow-sm">
