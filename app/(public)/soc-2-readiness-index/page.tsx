...
export const metadata: Metadata = {
  ...
  description:
    'Get an instant SOC 2 readiness score, gap highlights, and auditor roadmaps in under 2 minutes.',
  robots: {
    index: true,
    follow: true,
  },
    ...
    <>
      ...
      <main className="bg-gray-50 min-h-screen">
        <SoftwareApplicationSchema
          ...
          url="https://risclens.com/soc-2-readiness-index"
        ...
        <section className="py-10 md:py-12">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 space-y-4">
            <div id="calculator" className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
