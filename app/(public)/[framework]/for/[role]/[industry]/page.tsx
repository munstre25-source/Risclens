...
export async function generateStaticParams() {
  try {
    ...
    // Pre-render only high-intent combinations
    const [frameworksRes, rolesRes, industriesRes] = await Promise.all([
      ...
      supabase.from('pseo_roles').select('slug').limit(BUILD_CONFIG.ROLES_LIMIT),
    ...
    return limitStaticParams(params, BUILD_CONFIG.ROUTE_LIMITS.roleMatrix);
  } catch (err) {
