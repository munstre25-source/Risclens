...
export const metadata: Metadata = {
  title: 'Compliance Automation Comparison Hub | RiscLens',
  description: 'Compare leading compliance platforms side-by-side. Find the right tool for your SOC 2, ISO 27001, or HIPAA audit.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left space-y-6">
              ...
              <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 tracking-tight">
                  Compliance Automation <span className="text-brand-600">Market Intelligence</span>
              </h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 border-t border-slate-100 pt-8">
                ...
                <Link 
                  href="/compare/market-intelligence"
