        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-8">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-3">
            ...
            <div className="border border-slate-200 rounded-xl p-5 bg-white">
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Bridge to SOC 2</h3>
              <div className="flex flex-wrap gap-3 text-sm">
                <Link href="/soc-2" className="px-3 py-1.5 rounded-full border border-slate-200 text-brand-700 hover:border-brand-200">
                ...
                <Link href="/soc-2-cost-calculator" className="px-3 py-1.5 rounded-full border border-slate-200 text-brand-700 hover:border-brand-200">
                  SOC 2 Cost Calculator
                </Link>
                <Link href="/vendor-risk-assessment" className="px-3 py-1.5 rounded-full border border-slate-200 text-brand-700 hover:border-brand-200">
                  Vendor Assessment Hub
                </Link>
              </div>
            </div>
          </div>
