...
export function RiskClassifier() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4">
              ...
              <div className="grid gap-4">
                {questions[currentStep].options.map((option) => (
                  <button
                    ...
                    className="group flex items-center justify-between p-6 rounded-2xl border-2 border-slate-100 hover:border-indigo-600 hover:bg-indigo-50 transition-all text-left w-full"
                  >
          ...
          <div className="p-8 md:p-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className={`w-20 h-20 ${results[result].bgLight} rounded-3xl flex items-center justify-center mb-8`}>
              {(() => {
                ...
                return <Icon className={`w-10 h-10 ${results[result].textColor}`} />;
              })()}
            </div>
            
            <h3 className={`text-3xl font-black ${results[result].textColor} mb-4`}>
      ...
      <div className="mt-12 bg-indigo-900 rounded-2xl p-8 text-white text-left">
