          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              {[
                ...
                { href: '/iso-27001/timeline/fintech', label: 'ISO 27001 Fintech' },
                { href: '/hipaa/compliance-checklist/healthcare', label: 'HIPAA Healthcare' },
                { href: '/pci-dss/timeline/ecommerce', label: 'PCI DSS E-commerce' },
                { href: '/ai-governance/risk-assessment/ai-ml', label: 'AI Gov Risk' },
